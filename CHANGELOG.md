...
The project moves from "Lee's private daily-driver" to "anyone can install + run."
...
### Notes
- First v0.3 dogfood pending — verify AI sourcing top-10 with Lee's manual pick
