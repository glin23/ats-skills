---
name: ats-lever
description: Automate Lever ATS application form filling using CDP via shared/cdp.mjs. Trigger with "投这个 Lever URL：<url>" or "/ats-lever <url>". User must explicitly authorize the final Submit click — skill never auto-submits. v0.8 stable (real prior experience from Lee's Palantir attempt).
---
